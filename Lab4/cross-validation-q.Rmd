...
set.seed(lab.seed)
ridge = glmnet(x_train, y_train, lambda = 40, alpha = 0)
...
The log of the best lambda that we found is 0.98, which corresponds to the lowest MSE on the plot, dipping below 120000. 
...
lasso_pred = predict(lasso_cv, s = bestlam, newx = x_test) 
